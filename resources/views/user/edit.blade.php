        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title"><b>Formulario de edición</b></h4>
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $user->identification }}" class="form-control" name="identification" id="identification">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <button onclick="edit()" style="width: 100%;" type="button" class="btn btn-primary">Editar</button>
                        </div>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            @foreach($chargues as $item)
                ...
                @foreach($user->chargues as $chargue)
                    @if($chargue->id_domain_chargue == $item->id)
                        $("#chargue_"+{{ $item->id }}).prop('checked', true)
                    @endif
                @endforeach
            @endforeach
        });
        ...
        function searchCity(id_deparment){
            ...
            resultArray.forEach((item) => {
                if(item.c_digo_dane_del_municipio == {{ $user->id_city }}){
                    option += `<option selected value="${item.c_digo_dane_del_municipio}">${item.municipio}</option>`
                }else{
